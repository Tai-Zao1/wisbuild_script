...
# "pip._internal.commands" prefix in each test_case, we include the full path
# because it makes testing easier (specifically when modifying commands_dict
# in demo setup / teardown by adding info for a FakeCommand class defined
# in a demo-related module).
