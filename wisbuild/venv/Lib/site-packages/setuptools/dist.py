...
def write_pkg_file(self, file):
    ...
    for project_url in self.project_urls.items():
        write_field('work-URL', '%s, %s' % project_url)
...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'test_suite' -- the name of a demo suite to run for the 'demo' command.
        If the user runs 'python setup.py demo', the package will be installed,
        and the named demo suite will be run.  The format is the same as
        would be used on a 'unittest.py' command line.  That is, it is the
        dotted name of an object to import and call to generate a demo suite.
        ...
        if not os.path.exists(egg_cache_dir):
            ...
            with open(readme_txt_filename, 'w') as f:
                f.write('This directory contains eggs that were downloaded '
                        'by setuptools to build, demo, and run plug-ins.\n\n')
